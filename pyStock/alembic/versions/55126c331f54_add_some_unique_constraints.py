...
def upgrade():
    ...
    op.create_unique_constraint(u'unique_monetary_date', 'pystock_fxrates', ['date', 'monetary_source_id'])
    op.create_unique_constraint(None, 'pystock_exchange', ['code'])
    op.create_foreign_key("pystock_security_exchange_id_fkey", "pystock_security", "pystock_exchange", ["exchange_id"], ["id"])
